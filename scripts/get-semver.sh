...
# Semver calculation tool was written and maintained by François Saint-Jacques
# Version 3.2.0 was copied over from https://github.com/fsaintjacques/semver-tool/tree/3.2.0
